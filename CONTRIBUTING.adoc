...
= Contributing — BowtieRisk.jl
:toc: left

Contributions to `BowtieRisk.jl` follow the Hyperpolymath estate conventions:
...
[source,bash]
----
git clone git@github.com:hyperpolymath/BowtieRisk.jl.git
cd BowtieRisk.jl

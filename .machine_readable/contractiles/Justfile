...
doctor:
    @echo "Running diagnostics for BowtieRisk.jl..."
...
help-me:
    @echo "=== BowtieRisk.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/BowtieRisk.jl/issues/new"
    @echo ""
